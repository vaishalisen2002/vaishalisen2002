...
currently_leveling_up = [
    "⚔️  Competitive Coding       — sharpening problem-solving & DSA",
    "🔗  n8n Agentic Frameworks   — building no-code/low-code AI workflows",
    "🛠️  API Design               — RESTful principles, versioning & best practices",
    "🏗️  System Design            — scalable architectures, distributed systems",
]
```
